...
Each state is an observable checkpoint. When an installation fails, the user (and the logs) know _exactly_ where it failed. "It failed during VERIFYING" is far more actionable than "install failed."
