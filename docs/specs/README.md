...
This directory contains formal specifications that define UAS contracts.

Specs are written **before code**. Code must conform to specs — not the other way around.
