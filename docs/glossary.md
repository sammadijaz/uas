...
Executing the installation logic without making any actual changes to the system. The engine reports what _would_ happen. Used for previewing, debugging, and CI validation.
